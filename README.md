...
- [x] **📊 Data Complexity Level Control**: Allow users to control how much actual input data the AI can see when generating code. Provides 6 levels (0-5) from structure-only to full data, with automatic text truncation to manage token usage. This helps balance code generation quality with API costs.
